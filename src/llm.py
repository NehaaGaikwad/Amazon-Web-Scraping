...
def analyze_competitors(asin):
    ...
    lines = [
        "<span style='color:White; font-size:22px; font-weight:bold;'>Summary:</span>\n"
        + result.summary,

        "\n<span style='color:White; font-size:22px; font-weight:bold;'>Positioning:</span>\n"
        + result.positioning,

        "\n<span style='color:White; font-size:22px; font-weight:bold;'>Competitors:</span>"
    ]
    ...
    for c in result.top_competitors[:5]:
        ...
        price_html = f"<span style='color:#FFD700; font-weight:bold;'>{price_str}</span>"
        rating_html = f"<span style='color:#FFD700; font-weight:bold;'>{c.rating}</span>"

        lines.append(
            f"- {c.asin} | {c.title} | {price_html} | {rating_html}\n"
            f"  {pts}"
        )
    ...
    if result.recommendations:
        lines.append(
            "\n<span style='color:White; font-size:22px; font-weight:bold;'>Recommendations:</span>"
        )
